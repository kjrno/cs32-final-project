# cs32-final-project
My CS32 Final Project - A Symptom Checker

# Description
Program that gives user a questionaire to assess user's symptoms and returns a diagnosis with the most likely conditions with a percentage of likeliness. Provides recommended treatments for the condition that best matches the user's symptoms.
