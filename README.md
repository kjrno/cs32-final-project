...
# Description
Program that takes user-entered symptoms as inputs and returns a diagnosis with the disease that matches the most symptoms the user inputed. Provides recommended treatments based on the diagnosis.
